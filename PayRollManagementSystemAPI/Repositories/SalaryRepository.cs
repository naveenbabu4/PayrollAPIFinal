...
namespace PayRollManagementSystemAPI.Repositories
{
    public class SalaryRepository : ISalaryRepository
    {
        ...
        //    return null;
        //}
        public Task<Salary> CreateSalary(string id, Salary salary)
        {
            throw new NotImplementedException();
        }

        public Task<List<SalaryViewModel>> GetSalaryById(string id)
        {
            throw new NotImplementedException();
        }

        public Task<SalaryViewModel> GetSalaryByMonthById(string id, DateTime month)
        {
            throw new NotImplementedException();
        }

        public Task<List<SalaryViewModel>> GetSalaryByYearById(string id, DateTime year)
        {
            throw new NotImplementedException();
        }
    }
